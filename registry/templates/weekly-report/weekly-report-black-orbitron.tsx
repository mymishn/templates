...
export const WeeklyReportBlackOrbitron: React.FC<TemplateProps> = ({ duration, days = [], dayDurations = [] }) => {
  return (
    <div className="relative w-full h-full overflow-hidden">
      <div className="flex flex-col items-center justify-center h-full p-6 font-orbitron text-black gap-10">
